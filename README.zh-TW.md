...
-   使用的技術和職責：
    ...
    -   .NET 核心/框架
        ...
        -   MVC Razor 頁面，引導程式 (SURATKARGO.COM)
    ...
    -   JavaScript
        ...
        -   下一個
            -   建立 EPL(barcode-HTML) 視圖頁面的頁面，用於請求 eplprinter 網站取得不同的 json 資料集，以測試條碼設計是否失敗。
